...
from scripts.security import validate_local_path
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.out_dir:
        # Refuse --out-dir paths outside the allow-list so an agentic caller
        # cannot point us at /etc, /var, sibling user homes, etc.
        lib.LIBRARY_ROOT = validate_local_path(args.out_dir, must_exist=False)
