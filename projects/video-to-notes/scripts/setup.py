...
from scripts.security import secure_env_file
...
def _scaffold_env() -> None:
    ...
    # Re-apply restrictive perms on every run — covers the case where the user
    # created or edited .env outside this script and left it world-readable.
